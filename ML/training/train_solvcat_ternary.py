...
from solvgnn.model.model_GNN import solvcat_ternary
...
def data_flip(solvdata, perm):
    solvdata_flipped = {}
    if perm[0] == 0:
        if perm[1] == 1:
            solvdata_flipped = solvdata.copy()
        else:
            solvdata_flipped["g1"] = solvdata["g1"]
            solvdata_flipped["g2"] = solvdata["g3"]
            solvdata_flipped["g3"] = solvdata["g2"]
            solvdata_flipped["intra_hb1"] = solvdata["intra_hb1"]
            solvdata_flipped["intra_hb2"] = solvdata["intra_hb3"]
            solvdata_flipped["intra_hb3"] = solvdata["intra_hb2"]
            solvdata_flipped["inter_hb12"] = solvdata["inter_hb13"]
            solvdata_flipped["inter_hb13"] = solvdata["inter_hb12"]
            solvdata_flipped["inter_hb23"] = solvdata["inter_hb23"]
            solvdata_flipped["solv1_x"] = solvdata["solv1_x"]
            solvdata_flipped["solv2_x"] = 1 - solvdata["solv1_x"] - solvdata["solv2_x"]
            solvdata_flipped["gamma1"] = solvdata["gamma1"]
            solvdata_flipped["gamma2"] = solvdata["gamma3"]
            solvdata_flipped["gamma3"] = solvdata["gamma2"]
    elif perm[0] == 1:
        if perm[1] == 0:
            solvdata_flipped["g1"] = solvdata["g2"]
            solvdata_flipped["g2"] = solvdata["g1"]
            solvdata_flipped["g3"] = solvdata["g3"]
            solvdata_flipped["intra_hb1"] = solvdata["intra_hb2"]
            solvdata_flipped["intra_hb2"] = solvdata["intra_hb1"]
            solvdata_flipped["intra_hb3"] = solvdata["intra_hb3"]
            solvdata_flipped["inter_hb12"] = solvdata["inter_hb12"]
            solvdata_flipped["inter_hb13"] = solvdata["inter_hb23"]
            solvdata_flipped["inter_hb23"] = solvdata["inter_hb13"]
            solvdata_flipped["solv1_x"] = solvdata["solv2_x"]
            solvdata_flipped["solv2_x"] = solvdata["solv1_x"]
            solvdata_flipped["gamma1"] = solvdata["gamma2"]
            solvdata_flipped["gamma2"] = solvdata["gamma1"]
            solvdata_flipped["gamma3"] = solvdata["gamma3"]
        else:
            solvdata_flipped["g1"] = solvdata["g2"]
            solvdata_flipped["g2"] = solvdata["g3"]
            solvdata_flipped["g3"] = solvdata["g1"]
            solvdata_flipped["intra_hb1"] = solvdata["intra_hb2"]
            solvdata_flipped["intra_hb2"] = solvdata["intra_hb3"]
            solvdata_flipped["intra_hb3"] = solvdata["intra_hb1"]
            solvdata_flipped["inter_hb12"] = solvdata["inter_hb23"]
            solvdata_flipped["inter_hb13"] = solvdata["inter_hb12"]
            solvdata_flipped["inter_hb23"] = solvdata["inter_hb13"]
            solvdata_flipped["solv1_x"] = solvdata["solv2_x"]
            solvdata_flipped["solv2_x"] = 1 - solvdata["solv1_x"] - solvdata["solv2_x"]
            solvdata_flipped["gamma1"] = solvdata["gamma2"]
            solvdata_flipped["gamma2"] = solvdata["gamma3"]
            solvdata_flipped["gamma3"] = solvdata["gamma1"]
    elif perm[0] == 2:
        if perm[1] == 0:
            solvdata_flipped["g1"] = solvdata["g3"]
            solvdata_flipped["g2"] = solvdata["g1"]
            solvdata_flipped["g3"] = solvdata["g2"]
            solvdata_flipped["intra_hb1"] = solvdata["intra_hb3"]
            solvdata_flipped["intra_hb2"] = solvdata["intra_hb1"]
            solvdata_flipped["intra_hb3"] = solvdata["intra_hb2"]
            solvdata_flipped["inter_hb12"] = solvdata["inter_hb13"]
            solvdata_flipped["inter_hb13"] = solvdata["inter_hb23"]
            solvdata_flipped["inter_hb23"] = solvdata["inter_hb12"]
            solvdata_flipped["solv1_x"] = 1 - solvdata["solv1_x"] - solvdata["solv2_x"]
            solvdata_flipped["solv2_x"] = solvdata["solv1_x"]
            solvdata_flipped["gamma1"] = solvdata["gamma3"]
            solvdata_flipped["gamma2"] = solvdata["gamma1"]
            solvdata_flipped["gamma3"] = solvdata["gamma2"]
        else:
            solvdata_flipped["g1"] = solvdata["g3"]
            solvdata_flipped["g2"] = solvdata["g2"]
            solvdata_flipped["g3"] = solvdata["g1"]
            solvdata_flipped["intra_hb1"] = solvdata["intra_hb3"]
            solvdata_flipped["intra_hb2"] = solvdata["intra_hb2"]
            solvdata_flipped["intra_hb3"] = solvdata["intra_hb1"]
            solvdata_flipped["inter_hb12"] = solvdata["inter_hb23"]
            solvdata_flipped["inter_hb13"] = solvdata["inter_hb13"]
            solvdata_flipped["inter_hb23"] = solvdata["inter_hb12"]
            solvdata_flipped["solv1_x"] = 1 - solvdata["solv1_x"] - solvdata["solv2_x"]
            solvdata_flipped["solv2_x"] = solvdata["solv2_x"]
            solvdata_flipped["gamma1"] = solvdata["gamma3"]
            solvdata_flipped["gamma2"] = solvdata["gamma2"]
            solvdata_flipped["gamma3"] = solvdata["gamma1"]
    return solvdata_flipped


def train(epoch,train_loader,model,loss_fn1,loss_fn2,loss_fn3,optimizer):
    stage = "train"
    model.train()
...
def validate(epoch,val_loader,model,loss_fn1,loss_fn2,loss_fn3):
    stage = 'validate'
    batch_time = AccumulationMeter()
    loss_accum = AccumulationMeter()
    loss1_accum = AccumulationMeter()
...
def main():
    ...
    for train_indices, valid_indices in kf.split(all_ind,tpsa_binary):
        ...
        for epoch in range(100):
            ...
            train_loss = train(epoch,train_loader,model,loss_fn1,loss_fn2,loss_fn3,optimizer)
            ...
            val_loss = validate(epoch,val_loader,model,loss_fn1,loss_fn2,loss_fn3)
